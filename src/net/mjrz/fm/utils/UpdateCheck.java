		...
		try {
			...
			if (status == 200) {
				...
				JAXBContext jc = JAXBContext
						.newInstance("com.ifreebudget.web.service.response");
				Unmarshaller um = jc.createUnmarshaller();
				JAXBElement<UpdateCheckResponse> elem = (JAXBElement<UpdateCheckResponse>) um
						.unmarshal(new StringReader(str.toString()));
				...
				throw new RuntimeException(
						tr("Unable to get latest version, server unavailable."));
			}
		}
		finally {
			if (in != null) {
