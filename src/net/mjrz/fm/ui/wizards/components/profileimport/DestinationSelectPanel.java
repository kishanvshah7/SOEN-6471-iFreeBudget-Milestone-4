...
public class DestinationSelectPanel extends javax.swing.JPanel implements
		WizardComponent {

	private static final long serialVersionUID = 1L;

	/** Creates new form BackupSelectPanel */
	public DestinationSelectPanel() {
		initComponents();
	...
	private void initComponents() {
		...
		destinationFolderLbl = new javax.swing.JLabel();

		jLabel1.setText("Select destination folder:");
		...
		layout.setVerticalGroup(layout
				...
				.addGroup(
						layout.createSequentialGroup()
								...
								.addGap(18, 18, 18)
								.addComponent(destinationFolderLbl,
										javax.swing.GroupLayout.PREFERRED_SIZE,
										32,
										javax.swing.GroupLayout.PREFERRED_SIZE)
	...
	private void selectBActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (val == JFileChooser.APPROVE_OPTION) {
			...
			destinationFolderLbl.setText(f.getAbsolutePath());
		}
	}

	// Variables declaration - do not modify
	private javax.swing.JLabel destinationFolderLbl;
	...
	public String[][] getValues() {
		...
		row[0] = "DESTINATION";
		row[1] = destinationFolderLbl.getText();
	...
	public boolean isComponentValid() {
		String dest = destinationFolderLbl.getText();
		if (dest == null || dest.trim().length() == 0) {
			message = "Please select destination folder";
			return false;
		}
		return true;
	}
