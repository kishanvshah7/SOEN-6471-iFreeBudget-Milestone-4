...
public class UpdateCheckDialog extends JDialog {
	...
	private void initialize() {
		...
		JLabel l = null;
		l = new JLabel(
				tr("Do you want to check for updated version of iFreeBudget?"),
	...
	private void checkForUpdates() {
		SwingWorker<String, Object> worker = new SwingWorker<String, Object>() {
			public String doInBackground() {
				...
				try {
					URL url = new URL(
							net.mjrz.fm.ui.utils.UIDefaults.LATEST_VERSION_URL);
					...
					if (status == 200) {
						...
						logger.error("Unable to retrieve latest version: HTTP ERROR CODE: "
								+ status);
						return "";
					}
				}
					...
					if (v.isVersionGreater(str.toString())) {
						...
						int n = JOptionPane
								.showConfirmDialog(
										...
										msg
												+ "\n"
												+ tr("Do you want to download the latest version?"),
										tr("Message"),
						...
						JOptionPane.showMessageDialog(UpdateCheckDialog.this,
