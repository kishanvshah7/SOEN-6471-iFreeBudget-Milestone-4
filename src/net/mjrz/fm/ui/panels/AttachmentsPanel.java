...
public class AttachmentsPanel extends JPanel {
	...
	private void initialize() {
		...
		attachmentsList.setBorder(BorderFactory
	...
	public static class FileWrapper {
		...
		public String toString() {
			return new StringBuilder(file.getAbsolutePath()).append(" ( ")
					.append(length).append(" bytes) ").toString();
		}
	...
	static class AttachmentsFileFilter extends FileFilter {
